...
import com.voltstorage.konf.source.DefaultLoaders
import com.voltstorage.konf.source.Source
import com.voltstorage.konf.source.base.kvToTree
...
interface Config : ItemContainer {
     ...
     * This map can be loaded into config as [com.voltstorage.konf.source.base.KVSource] using
