...
package io.github.voltstorage.konf.source
...
import io.github.voltstorage.konf.EmptyNode
import io.github.voltstorage.konf.Feature
import io.github.voltstorage.konf.Item
import io.github.voltstorage.konf.ListNode
import io.github.voltstorage.konf.MapNode
import io.github.voltstorage.konf.MergedMap
import io.github.voltstorage.konf.NullNode
import io.github.voltstorage.konf.Path
import io.github.voltstorage.konf.SizeInBytes
import io.github.voltstorage.konf.TreeNode
import io.github.voltstorage.konf.ValueNode
import io.github.voltstorage.konf.annotation.JavaApi
import io.github.voltstorage.konf.source.base.ListStringNode
import io.github.voltstorage.konf.source.base.toHierarchical
import io.github.voltstorage.konf.toLittleCamelCase
import io.github.voltstorage.konf.toPath
import io.github.voltstorage.konf.toValue
    ...
    when (type) {
        ...
        is ArrayType -> {
            ...
            if (!clazz.isPrimitive) {
                ...
                return (list as Collection<*>).toArray(array)
            } else {
                @Suppress("UNCHECKED_CAST")
                return when (clazz) {
