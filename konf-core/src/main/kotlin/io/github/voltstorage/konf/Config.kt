...
import io.github.voltstorage.konf.source.DefaultLoaders
import io.github.voltstorage.konf.source.Source
import io.github.voltstorage.konf.source.base.kvToTree
...
interface Config : ItemContainer {
     ...
     * This map can be loaded into config as [io.github.voltstorage.konf.source.base.KVSource] using
