...
package io.github.voltstorage.konf.source.serializer
...
import io.github.voltstorage.konf.source.json.toJson
...
private class WrappedStringStdSerializer : com.fasterxml.jackson.databind.ser.std.StdSerializer<WrappedString>(WrappedString::class.java) {
...
private class WrappedStringStdDeserializer : com.fasterxml.jackson.databind.deser.std.StdDeserializer<WrappedString>(
    WrappedString::class.java,
) {
