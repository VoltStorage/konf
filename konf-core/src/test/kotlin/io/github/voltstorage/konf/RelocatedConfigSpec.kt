...
object RelocatedConfigSpec : SubjectSpek<Config>({
    ...
    subject { Prefix("network.buffer") + Config.Companion { addSpec(NetworkBuffer) }.at("network.buffer") }
...
object RollUpConfigSpec : SubjectSpek<Config>({
    ...
    subject { Prefix("prefix") + Config.Companion { addSpec(NetworkBuffer) } }
...
object MultiLayerRollUpConfigSpec : SubjectSpek<Config>({
    ...
    subject { (Prefix("prefix") + Config.Companion { addSpec(NetworkBuffer) }).withLayer("multi-layer") }
...
object DrillDownConfigSpec : SubjectSpek<Config>({
    ...
    subject { Config.Companion { addSpec(NetworkBuffer) }.at("network") }
...
object MultiLayerDrillDownConfigSpec : SubjectSpek<Config>({
    ...
    subject { Config.Companion { addSpec(NetworkBuffer) }.at("network").withLayer("multi-layer") }
...
object DrillDownMultiLayerConfigSpec : SubjectSpek<Config>({
    ...
    subject { Config.Companion { addSpec(NetworkBuffer) }.withLayer("multi-layer").at("network") }
...
object MultiLayerRollUpFallbackConfigSpec : SubjectSpek<Config>({
    subject {
        (
            (
                Prefix("prefix") +
                    Config.Companion { addSpec(NetworkBuffer) }.withLayer("layer1")
            ).withLayer("layer2") +
                Config.Companion()
        ).withLayer("layer3")
    }
