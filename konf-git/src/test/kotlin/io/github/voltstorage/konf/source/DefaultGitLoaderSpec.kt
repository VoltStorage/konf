...
import io.github.voltstorage.konf.tempDirectory
...
object DefaultGitLoaderSpec : SubjectSpek<DefaultLoaders>({
    ...
    given("a loader") {
            ...
            tempDirectory().let { dir ->
                Git.init().apply {
                    ...
                    Paths.get(
                        dir.path,
                        "source.properties",
                    ).toFile().writeText(PROPERTIES_CONTENT)
                    git.add().apply {
        ...
        mapOf(
            "load from watched git repository" to {
            ...
            on(description) {
                tempDirectory(
                    ...
                    it(
                        "should load new value after file content in git repository has been changed",
                    ) {
                        assertThat(
                            newValue,
                            equalTo("newValue"),
